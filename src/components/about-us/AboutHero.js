...
<<<<<<< HEAD
    <div className=''>
      ...
      <div className='herosection leading-[3rem] flex md:flex-row flex-col  gap-3 md:items-center items-start justify-between xl:px-40 lg:px-10 px-5 wow  animate__animated  animate__fadeInDown'>
=======
...
<<<<<<< HEAD
        <div className='img about-header-image relative h-[20rem] w-[30rem]'>
          <Image src={data.img}  fill sizes='100%' alt="" className='' loading="lazy"/>
        </div>
      </div>  
    </div>
=======
