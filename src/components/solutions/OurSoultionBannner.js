...
export default function OurSoultionBannner({data}) {
  return (
    <section className="relative w-full lg:h-[50vh] h-full bg-white my-10 flex items-center wow  animate__animated  animate__fadeInUp">
      <div className="relative z-10 flex items-center  lg:flex-row flex-col-reverse justify-between xl:px-40 px-5 w-full h-full bg-gradient-to-r from-[#000] to-red-900  text-white py-10 gap-5 overflow-hidden">
      <div className="absolute z-1 lg:top-60 bottom-0 left-0 lg:rotate-30 wow  animate__animated  animate__fadeInLeft" data-wow-delay="0.5s">
        <Image loading="lazy" src='/assets/images/shape/imgi_138_learning-bg.svg' className='lg:h-[25rem] h-full w-full' fill sizes='100%' alt=""/>
      </div>
=======
export default function OurSoultionBannner({ data }) {
  return (
...
<<<<<<< HEAD
        ...
        <div className="lg:basis-[40%] basis-full w-full lg:h-[20rem] h-[40px] wow  animate__animated  animate__fadeInRight relative" data-wow-delay="0.3s">
            <Image loading="lazy" src={data.img1} className='h-[20rem] w-full object-contain ' fill sizes='100%' alt=""/>
=======
            <RedArrowButton data={"Get Started with Us"} />
          </div>
        </div>
