            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 gap-4 wow  animate__animated  animate__fadeInUp">
                <div className="flex lg:flex-col md:flex-row flex-col lg:gap-20 gap-4 text-black">
                    <div className="bg-white rounded-lg  border-gray-200 border p-6">
                        ...
                        <p className="font-dark text-[1.1rem]">We delve deep into understanding our client&apos;s aspirations, challenges, and unique requirements.</p>
                    </div>
                    <div className="bg-white rounded-lg  border-gray-200 border p-6">
                        <h3 className="text-xl font-bold lg:mb-2"><span className="text-[#751212] mr-2">03.</span> Execution</h3>
                        <p className="font-dark text-[1.1rem]">Our skilled team employs cutting-edge technologies to the latest design principles to bring the chosen concept to life.</p>
                    </div>
                </div>
                ...
                <div className="flex lg:flex-col md:flex-row flex-col lg:gap-20 gap-4 text-black">
                    <div className="bg-white rounded-lg  border-gray-200 border p-6">
                        ...
                        <p className="font-dark text-[1.1rem]">With a thorough understanding of our client&apos;s needs, our next step involves the exciting process of concept generation.</p>
                    </div>
                    <div className="bg-white rounded-lg  border-gray-200 border p-6">
                        <h3 className="text-xl font-bold lg:mb-2"><span className="text-[#751212] mr-2">04.</span> Completion</h3>
                        <p className="font-dark text-[1.1rem]">We meticulously review the final product, leaving no stone unturned to guarantee its functionality, and overall performance.</p>
                    </div>
                </div>
            </div>
        </section>
